...
CLASS_DECLARATION( idPlayer, D3BasePlayer )
END_CLASS

/*
==============
D3BasePlayer::D3BasePlayer
==============
*/
D3BasePlayer::D3BasePlayer() {
}
...
/*
================
D3BasePlayer::UpdateLocation

Searches nearby locations
================
*/
void D3BasePlayer::UpdateLocation( void ) {
	if ( hud ) {
		idLocationEntity *locationEntity = static_cast<idD3BaseLocal *>(GameLocal())->LocationForPoint( GetEyePosition() );
		if ( locationEntity ) {
