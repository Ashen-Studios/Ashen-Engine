...
idGameEdit *					CreateGameEditorInstance();
...
idAnimManager *					CreateAnimManagerInstance();
...
// v8 = Original Doom 3 GPL API version
// v9 = Allowed overriding gameLocal and gameEditLocal pointers aka you can now use your own subclasses of idGameLocal and idGameEditLocal
